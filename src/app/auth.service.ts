...
export class AuthService {
  ...
  constructor(private webService: WebRequestServiceService, private router: Router, private http: HttpClient) { }
...
/*
  updatePass(email: string, password: string) {
  ...
  */
  ...
  forgot(email: string) {
    return this.webService.forgot(email).pipe(
      shareReplay()
    )
  }
